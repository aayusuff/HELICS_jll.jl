...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import HELICS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("ef3b0bb0-9dc6-5204-90f3-946fd7d0da3e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "HELICS", artifacts_toml) for e in artifacts["HELICS"]]
...
if best_platform === nothing
    @debug("Unable to load HELICS; unsupported platform $(triplet(platform_key_abi()))")
else
